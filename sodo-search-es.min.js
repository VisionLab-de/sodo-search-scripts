  ...
  */
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className, ref: containerRef, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          ...
          placeholder: "Contribuciones de búsqueda"
        }
      ),
  ...
  function PostResults({ posts, selectedResult, setSelectedResult }) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-neutral-200 py-3 px-4 sm:px-7", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "uppercase text-xs text-neutral-400 font-semibold mb-1 tracking-wide", children: "Contribuciones" }),
      PostItems,
  ...
  function NoResultsBox() {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-4 px-7", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[1.65rem] text-neutral-400 leading-normal", children: "No se han encontrado resultados" }) });
  }
  function Search() {
    const { dispatch } = reactExports.useContext(AppContext);
